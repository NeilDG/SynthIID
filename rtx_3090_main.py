...
def test_albedo():
    os.system("python \"iid_test_main.py\" --server_config=5 --img_to_load=1000 "
              "--img_vis_enabled=0 --network_version=\"rgb2albedo_v01.08_iid\" --iteration=1")

    os.system("python \"iid_test_main.py\" --server_config=5 --img_to_load=1000 "
              "--img_vis_enabled=0 --network_version=\"rgb2albedo_v01.09_iid\" --iteration=1")

    os.system("python \"iid_test_main.py\" --server_config=5 --img_to_load=1000 "
              "--img_vis_enabled=0 --network_version=\"rgb2albedo_v01.10_iid\" --iteration=1")
def plot_test():
...
def train_normal():
    ...
    os.system("python \"iid_train_main.py\" --server_config=5 --plot_enabled=0 --save_per_iter=1000 "
              "--network_version=\"rgb2normal_v01.08_iid\" --iteration=1")
...
def test_normal():
    ...
    os.system("python \"iid_test_main.py\" --server_config=5 --img_to_load=1000 --test_mode=\"normal\" "
              "--img_vis_enabled=1 --network_version=\"rgb2normal_v01.07_iid\" --iteration=1")
