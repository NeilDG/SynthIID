...
def train_albedo():
    os.system("python \"iid_train_main.py\" --server_config=3 "
...
def test_albedo():
    os.system("python \"iid_test_main.py\" --server_config=3 --img_to_load=1000 "
              "--img_vis_enabled=1 --network_version=\"rgb2albedo_v01.06_iid\" --iteration=1")

def plot_test():
    os.system("python \"plot_test_util.py\" --server_config=3 --img_to_load=-1 --img_vis_enabled=1")

def train_normal():
    os.system("python \"iid_train_main.py\" --server_config=3 --plot_enabled=0 --save_per_iter=1000 "
