...
def train_albedo():
    os.system("python3 \"iid_train_main.py\" --server_config=3 "
              "--plot_enabled=0 --save_per_iter=500 --network_version=\"rgb2albedo_v01.08_iid\" --iteration=1")

    os.system("python3 \"iid_train_main.py\" --server_config=3 "
              "--plot_enabled=0 --save_per_iter=500 --network_version=\"rgb2albedo_v01.09_iid\" --iteration=1")

    os.system("python3 \"iid_train_main.py\" --server_config=3 "
              "--plot_enabled=0 --save_per_iter=500 --network_version=\"rgb2albedo_v01.10_iid\" --iteration=1")
